...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5fb933a8ba0225_44618205',
  'has_nocache_code' => true,
  'cache_lifetime' => 31536000,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fb933a8ba0225_44618205')) {function content_5fb933a8ba0225_44618205($_smarty_tpl) {?>
	<!-- Block CMS module -->
			<section id="informations_block_left_1" class="block informations_block_left">
			<p class="title_block">
				<a href="http://localhost/prestashop/content/category/1-accueil">
					Informations				</a>
			</p>
			<div class="block_content list-block">
				<ul>
																							<li>
								<a href="http://localhost/prestashop/content/1-livraison" title="Livraison">
									Livraison
								</a>
							</li>
																								<li>
								<a href="http://localhost/prestashop/content/2-mentions-legales" title="Mentions légales">
									Mentions légales
								</a>
							</li>
																								<li>
								...
								<a href="http://localhost/prestashop/content/4-a-propos" title="A propos">
									A propos
																								...
																								<li>
								<a href="http://localhost/prestashop/content/5-paiement-securise" title="Paiement sécurisé">
									Paiement sécurisé
								</a>
							</li>
																						<li>
